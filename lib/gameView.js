(function () {
  ...
  GameView.prototype.startScreen = function () {
    ...
    document.getElementById("game").addEventListener("click", this.start.bind(this));
  ...
  GameView.prototype.drawEnd = function (ctx, elapsed) {
        ...
        this.centerText(ctx, "click or press 'n' for a new game", y + 60);
    };
  GameView.prototype.drawStart = function (ctx, elapsed) {
        ...
        ctx.fillStyle = "blue";
        ctx.font = '34px monospace';
        this.centerText(ctx, "click or press 'n' to start a new game", y + 60);
  };
